...
static NSString * const dailyIntervalNotificationTriggerHourKey = @"hour";
...
- (UNNotificationTrigger *)triggerFromParams:(NSDictionary *)params
{
  ...
  if ([intervalNotificationTriggerType isEqualToString:triggerType]) {
    ...
    NSNumber *hour = [params objectForKey:dailyIntervalNotificationTriggerHourKey verifyingClass:[NSNumber class]];
