...
static NSString * const dailyIntervalNotificationTriggerType = @"daily";
static NSString * const dailyIntervalNotificationTriggerHourOfDayKey = @"hourOfDay";
static NSString * const dailyIntervalNotificationTriggerMinuteKey = @"minute";
...
- (UNNotificationTrigger *)triggerFromParams:(NSDictionary *)params
{
  ...
  } else if ([dailyIntervalNotificationTriggerType isEqualToString:triggerType]) {
    NSNumber *hourOfDay = [params objectForKey:dailyIntervalNotificationTriggerHourOfDayKey verifyingClass:[NSNumber class]];
    NSNumber *minute = [params objectForKey:dailyIntervalNotificationTriggerMinuteKey verifyingClass:[NSNumber class]];
    NSDateComponents *dateComponents = [NSDateComponents new];
    dateComponents.hour = [hourOfDay integerValue];
