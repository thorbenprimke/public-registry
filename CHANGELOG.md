...
- Fixed notification to be dismissed automatically when clicked. This is customized with the  `sticky` parameter of `NotificationContentInput`. The default value is false. ([#8241](https://github.com/expo/expo/pull/8241) by [@thorbenprimke](https://github.com/thorbenprimke))
